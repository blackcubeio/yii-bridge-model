...
Bridge works transparently with the Elastic dynamic properties of [blackcube/active-record](https://github.com/blackcubeio/active-record).
...
| `property` | `string|false|null` | Explicit target property (`false` skips the target) |
