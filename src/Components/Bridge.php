...
class Bridge
{
    ...
    public function setEndpoint(
        ...
        $update = array_filter([
            ...
            'type' => $type,
            'format' => $format,
            'isNullable' => $isNullable === true ? true : null,
            'isElastic' => $isElastic === true ? true : null,
        ], fn ($value) => $value !== null);
    ...
    public function get(mixed $model): mixed
    {
        ...
        if (isset($this->endpoints[$className]) === false) {
    ...
    {
        return isset($this->endpoints[$className]) === true;
    }
    ...
    {
        $className = get_class($model);
        if (isset($this->endpoints[$className]['type']) === false) {
            return null;
        }
    ...
    {
        $className = get_class($model);
        if (isset($this->endpoints[$className]['format']) === false) {
            return null;
        }
    ...
    {
        $className = get_class($model);
        if (isset($this->endpoints[$className]['isNullable']) === false) {
            return false;
        }
